...
import {fetchUserData, logoutUser, updateUserData} from '../../services/auth/authSlice';
...
function Profile() {
  ...
  useEffect(() => {
    ...
    if (name !== initialUserData.name || email !== initialUserData.email || password) {
      setIsModified(true);
    } else {
      setIsModified(false);
    }
  }, [name, email, password, initialUserData]);
